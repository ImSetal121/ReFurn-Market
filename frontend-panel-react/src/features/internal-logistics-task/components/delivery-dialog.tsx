...
interface DeliveryDialogProps {
    ...
    onDeliver: (imageUrls: Record<string, string>, remark: string) => void
}

export function DeliveryDialog({ open, onOpenChange, task, onDeliver }: DeliveryDialogProps) {
        ...
        <Dialog open={open} onOpenChange={handleClose}>
            <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
                ...
                <div className="grid gap-4 py-4">
                    ...
                    {/* 备注 */}
                    <div className="space-y-2">
                        <Label htmlFor="delivery-remark">备注</Label>
                        <Textarea
                            id="delivery-remark"
                            placeholder="请输入送达备注信息..."
                            value={remark}
